...
if __name__ == "__main__":
    ...
    #
    parser.add_argument('--model', type=str, default='vgg_two_third',
    ...
    parser.add_argument("--epoch", type=str, default="249")
    parser.add_argument("--samples", type=str, default=10)
    parser.add_argument("--debug", type=str, default=False)
    parser.add_argument("--save", type=str, default="results")

    parser.add_argument("--weight_of_ece", type=float, default=1)#700
    ...
    if load:
        ...
        # Search Result
        # print('Search Result:')
        error, ece, _ = classification_evaluation_loader(choice_dict, model, args, loader=test_loader)#test_loader valid_loader
